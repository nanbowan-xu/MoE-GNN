...
def evaluate(model, loader):
    ...
    for batch_data in loader:
        a2a_g, b2a_g, b2b_gl,xxx, feats, types, counts, y = batch_data
        _, y_hat,loss1 = model(a2a_g, b2a_g, b2b_gl,xxx, types, counts,y)
...
def train(args, model, trn_loader, tst_loader, val_loader):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch_data in tqdm(trn_loader):
            a2a_g, b2a_g, b2b_gl,xxx, feats, types, counts, y = batch_data
            feats_hat, y_hat,loss1 = model(a2a_g, b2a_g, b2b_gl,xxx, types, counts,y)
