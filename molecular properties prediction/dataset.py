...
class Molecule2DView(MoleculeDataset):
    ...
    def build_graph(self, mol):
        ...
        a2a_graph = pgl.Graph(a2a_edges, num_nodes=num_nodes, node_feat={"feat": atom_features,"coord":atom_2dcoords}, edge_feat={"dist": dist_feats}) # dist_feats: (num_edges_of_node, )
...
class Molecule3DView(MoleculeDataset):
    ...
    def build_graph(self, mol):
        ...
        a2a_graph = pgl.Graph(a2a_edges, num_nodes=num_nodes, node_feat={"feat": atom_features,"coord":atom_3dcoords}, edge_feat={"dist": dist_feats})
        ...
        e2a_graph = pgl.Graph(b2a_edges, num_nodes=num_nodes, node_feat={"feat": atom_features,"coord":atom_3dcoords}, edge_feat={"dist": dist_feats})
